...
import com.cn.lp.converter.annotation.JudgeEmptyMethod;
...
public class JudgeEmptyMethodAnnotation extends ElementAnnotation {

    public static final TypeName ANNOTATION_TYPE_NAME = ClassName.get(JudgeEmptyMethod.class);

    public static JudgeEmptyMethodAnnotation build(AnnotationMirror annotationMirror) {
        JudgeEmptyMethodAnnotation elementAnnotation = new JudgeEmptyMethodAnnotation();
