...
public class TypeChangeMethodAnnotation extends ElementAnnotation {

    public static final TypeName ANNOTATION_TYPE_NAME = ClassName.get(TypeChangeMethod.class);

    public static TypeChangeMethodAnnotation build(AnnotationMirror annotationMirror) {
        TypeChangeMethodAnnotation elementAnnotation = new TypeChangeMethodAnnotation();
